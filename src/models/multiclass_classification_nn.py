...
def encode_labels(y):
    ...
    return y_categorical, encoder.classes_

def build_model(input_dim, num_classes):
    """ Build and compile a neural network for multi-class classification. """
    model = Sequential([
...
def main():
    """
    Train a neural network model for multi-class classification using the specified dataset and target column.
    """
    parser = argparse.ArgumentParser(description="Neural Network for Multi-Class Classification")
    ...
    mlflow.set_experiment("multiclass_classification_nn")
